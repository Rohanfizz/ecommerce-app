...
import { addAdminProducts, fetchProductById, fetchProductByIdAdmin, updateAdminProducts } from "../../api/products";
...
const AddProductModal = ({ isOpen, onClose }) => {
    ...
    const productUpdater = async () => {
      const res = await addAdminProducts(data);
    };
    ...
    const infoOnChangeHandler = (e) => {
        setData((p)=>{return {...p,info:e.target.value}});
    };
